...
public class ERentalWebSecurityConfig extends WebSecurityConfigurerAdapter {

    private UserDetailsService userDetailsService;

    public ERentalWebSecurityConfig(ERentalUserDetailsService userDetailsService){
