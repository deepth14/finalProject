...
public class MortgageTest {
	...
	public void test1() {
		...
		Customer customer = new Customer(birthday, 3000, 0, "Architect", "single");
	...
	public void test3() {
		...
		Customer customer = new Customer(birthday, 4000, 2000, "Developer", "married");
		double result = mc.computeMaxMortgage(customer);
	...
	public void test4() {
		...
		Customer customer = new Customer(birthday, 5500, 0, "Professor", "single");
		double result = mc.computeMaxMortgage(customer);
